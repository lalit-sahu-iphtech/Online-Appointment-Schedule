...
3. Set up environment variables
   ...
   VITE_EMAILJS_PUBLIC_KEY=VDYus9qv_xx
   VITE_EMAILJS_TEMPLATE_ID=template_xxx
   VITE_EMAILJS_CANCELLATION_TEMPLATE_ID=xxxx
   VITE_EMAILJS_REMINDER_SERVICE_ID=xxx
   VITE_EMAILJS_REMINDER_PUBLIC_KEY=xxx
   VITE_EMAILJS_REMINDER_TEMPLATE_ID=template_xx
   VITE_EMAILJS_THANKYOU_TEMPLATE_ID=template_xx
   ```
